...
%\usepackage[style=apa, sorting=none, backend=biber, doi=false, isbn=false]{biblatex}
%\newcommand*{\bibtitle}{References}

% The humanities-type option: author-year in-text citation with an alphabetical works cited.
\usepackage[style=authoryear, sorting=none, backend=biber, maxcitenames=2, useprefix, doi=false, isbn=false]{biblatex}
\newcommand*{\bibtitle}{References}
...
\part{Methodology}
\include{text/ch3-DCNs}
\include{text/ch4-DCN-LAs}

\part{Experiments and Discussion}
\include{text/ch5-experiments}

\part{Conclusion and Future Work}
\include{text/ch6-conclusion}
\include{text/ch7-future-work}
